...
docker-compose exec -T commons sh -c "curl -kL http://internal-services-test:3000/mysql-8-0 " | grep "SERVICE_HOST=8.0"
docker-compose exec -T commons sh -c "curl -kL http://internal-services-test:3000/mysql-8-0 " | grep "LAGOON_TEST_VAR=all-images"
